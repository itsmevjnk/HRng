...
namespace GetUID
{
    public class UID
    {
        ...
        {
            UserAgent ua = new UserAgent(); // Object for generating fake User-Agent strings
            ...
            for (int i = 0; i < 3; i++) // retry for 3 times at most
            {
                ...
                HTTPClient.DefaultRequestHeaders.Add("User-Agent", ua.Next()); // Load fake User-Agent string so Cloudflare won't block us
